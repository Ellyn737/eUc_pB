...
//		System.out.println(System.getProperties());
	...
	public void setChangeAdminDialog() {
		Alert dialog = new Alert(AlertType.WARNING, "Bitte geben Sie die erforderlichen Ver�nderungen ein.", ButtonType.OK);
		dialog.setTitle("�NDERUNGEN F�R DEN BIBLIOTHEKAR");
		dialog.setHeaderText("Sie m�chten die Daten f�r den Bibliothekar �ndern.");
...
//			check if everything is filled out
			if(changes.size() < 1) {
				...
				String message2 = "Bitte f�llen Sie alle Felder aus. ";
				setWarning(message1, message2);
			}else {
				lc.changeLibrarian(changes);
				String message1 = "Die �nderungen wurden gespeichert.";
				String message2 = "Dr�cken Sie auf OK und fahren Sie fort.";
				setWarning(message1, message2);
//				close dialog
				dialog.close();
			}
